...
namespace JobWize.Shared.Runtime.Validation
{
    public static class ModuleValidator
    {
        ...
        private static void ValidateRequestsHaveExactlyOneHandler(
        ...
        private static void ValidateHandlersTargetKnownRequests(
            ModuleDescriptor descriptor)
        {
